...
class KarigarUpdateStatusScreen extends StatefulWidget {
  ...
  @override
  State<KarigarUpdateStatusScreen> createState() => _KarigarUpdateStatusScreenState();
}
...
class _KarigarUpdateStatusScreenState extends State<KarigarUpdateStatusScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Text('Order No.', style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
                        const Spacer(),
                        Text(_order!.orderNo, style: const TextStyle(fontWeight: FontWeight.w700)),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        Text(_order!.customerName, style: const TextStyle(fontWeight: FontWeight.w500)),
                      ],
                    ),
                    const SizedBox(height: 8),
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        Text(_order!.dueDate, style: const TextStyle(fontWeight: FontWeight.w500)),
                      ],
                    ),
                    const SizedBox(height: 8),
                    Row(
            ...
            // Status selection
            Text('Status', style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w500)),
            const SizedBox(height: 10),
            _buildStatusOption('InProgress', 'In Progress', Icons.engineering, AppColors.statusInProgress,
                'Mark that you have started working on this order'),
            const SizedBox(height: 10),
            _buildStatusOption('Ready', 'Ready', Icons.check_circle_outline, AppColors.statusReady,
  ...
  Widget _buildStatusOption(String value, String label, IconData icon, Color color, String description) {
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(label, style: TextStyle(fontWeight: FontWeight.w600, color: isSelected ? color : AppColors.textPrimary)),
